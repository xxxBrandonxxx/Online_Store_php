    ...
    <main>
        ...
        <div class="jumbotron mt-5 p-3 p-md-5 text-dark bg-light">
            <div class="col-md-6 px-0">
                ...
                <p class="lead my-3">Skate your way Down to our nearest store</p>
            </div>
        </div>
        <!-- Hero END -->

        <h2 class="text-center mt-4">We are located right here!!!</h2>
        <div class="maps-container">
            <i class="fa-solid fa-mobile-screen-button fa-xl"></i> <a href="tel:021123465">078 100 5757</a>
